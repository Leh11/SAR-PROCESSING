...
ideal <- loadImage("/Dev/R/SAR-PROCESSING/PolSAR/image/ideal/pauli.png", 
                   CIELab = TRUE, sample.size = NULL, ref.white = "D65",
                   lower = NULL, upper = NULL)

# read the ideal "lena"
ideal_lena <- loadImage("/Dev/R/SAR-PROCESSING/PolSAR/image/ideal/lena.png", 
                      CIELab = TRUE, sample.size = NULL, ref.white = "D65",
                      lower = NULL, upper = NULL)

# read the ideal "mandrill"
ideal_mandrill <- loadImage("/Dev/R/SAR-PROCESSING/PolSAR/image/ideal/mandrill.png", 
                        CIELab = TRUE, sample.size = NULL, ref.white = "D65",
                        lower = NULL, upper = NULL)

ideal_lighthouse <- loadImage("/Dev/R/SAR-PROCESSING/PolSAR/image/ideal/lighthouse.png", 
                            CIELab = TRUE, sample.size = NULL, ref.white = "D65",
                            lower = NULL, upper = NULL)

ideal_mount <- loadImage("/Dev/R/SAR-PROCESSING/PolSAR/image/ideal/mount.png", 
                            CIELab = TRUE, sample.size = NULL, ref.white = "D65",
                            lower = NULL, upper = NULL)
```
