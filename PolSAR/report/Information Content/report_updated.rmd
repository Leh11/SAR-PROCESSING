...
boat <- load.image("../../image/original/Sailboat.jpeg")

lpoints <- boat[,,,1]

## convertendo lena para lab
lab_boat <- RGBtoLab(boat)
...
title("Visualizacão da imagem ideal")
