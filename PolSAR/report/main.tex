...
\includegraphics[width=.30\linewidth]{logo.png} \hspace{30cm}
...
\newpage
\justify
\textbf{\large\centering{TÍTULO DO PLANO DE TRABALHO INDIVIDUAL\\}}
\textbf{\centering{Desenvolvimento do software com as funcionalidades
...
\begin{figure}[H]
	\centering
	\includegraphics[width=4cm, height=10cm]{Pauli.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=4cm, height=10cm]{Krogager.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=4cm, height=10cm]{Hyunen.png}
